        ...
        <div class="col-lg-3 col-md-12 col-sm-12" style="margin-top: 10px;">
                <div class="card border-primary mb-3" style="max-width: 25rem;">
                    <div class="card-header" align="center">
                        <h4 class="card-title text-dark">Registro de Dias</h4>
                    </div>
                    <div class="card-body">
                        <form action="Insert/RegistrarDias.php" method="post">
                            <input type="text" name="dia" class="form-control" maxlength="10" placeholder="Dia" required> 
            ...
            <div class="col-lg-9 col-md-12 col-sm-12" style="margin-top: 10px;">
                ...
                <?php
                    require('../../conexion.php'); 
                    $querySelect = "SELECT * FROM tbl_dias";
                    ...
                    <table class="table table-bordered table-hover table-condensed order-table">
                        ...
                        while ($Fila = mysqli_fetch_array($resbb)) {
                            ?>
                            <tr>
                                <td align="center"> <?php echo $Fila['clv_dia'] ?> </td>
                                <td align="center"> <?php echo $Fila['vch_dia'] ?> </td>
                                <td align="center"> 
                                    <a href="Update/EditarDias.php?id=<?php echo $Fila['clv_dia']?>" class="btn btn-small btn-warning">Editar</a>
                                    <a href="Delete/EliminarDias.php?id=<?php echo $Fila['clv_dia']?>" class="btn btn-small btn-danger">Eliminar</a>
                                </td>
                            </tr>
                        <?php
                        }
