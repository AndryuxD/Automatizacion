        ...
        <div class="col-lg-3 col-md-12 col-sm-12" style="margin-top: 10px;">
                <div class="card border-primary mb-3" style="max-width: 25rem;">
                    <div class="card-header" align="center">
                        <h4 class="card-title text-dark">Registro de Grupos</h4>
                    </div>
                    <div class="card-body">
                        <form action="Insert/RegistrarGrupos.php" method="post">
                            <input type="text" name="grupo" class="form-control" maxlength="15" placeholder="Grupo" required> 
                            <br>
                            Turno
                            <select name="cmbturno" size="1" class="form-control">
            ...
            <div class="col-lg-9 col-md-12 col-sm-12" style="margin-top: 10px;">
                ...
                <?php 
                    $querySelect = "SELECT * FROM tbl_grupos,tbl_cuatrimestre,tbl_carreras
                                        WHERE tbl_grupos.`clv_carrera` = tbl_carreras.`clv_carrera`
                                        AND tbl_grupos.`clv_cuatrimestre` = tbl_cuatrimestre.`clv_cuatrimestre`";
                    ...
                    <table class="table table-bordered table-hover table-condensed order-table">
                        ...
                        while ($Fila = mysqli_fetch_array($resbb)) {
                            ?>
                            <tr>
                                <td align="center"> <?php echo $Fila['clv_grupo'] ?> </td>
                                ...
                                <td align="center"> 
                                    <a href="Update/EditarGrupos.php?id=<?php echo $Fila['clv_grupo']?>" class="btn btn-small btn-warning">Editar</a>
                                    <a href="Delete/EliminarGrupos.php?id=<?php echo $Fila['clv_grupo']?>" class="btn btn-small btn-danger">Eliminar</a>
                                </td>
                            </tr>
                        <?php
                        }
