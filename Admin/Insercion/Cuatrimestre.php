...
<br>
    <div class="container-fluid" id="aplicacion">
        <h1 align="center">Cuatrimestre</h1>
        <div class="row">
        <div class="col-lg-3 col-md-12 col-sm-12" style="margin-top: 10px;">
                <div class="card border-primary mb-3" style="max-width: 25rem;">
                    <div class="card-header" align="center">
                        <h4 class="card-title text-dark">Registro de Cuatrimestre</h4>
                    </div>
                    <div class="card-body">
                        <form action="Insert/RegistrarCuatrimestre.php" method="post">
                            <input type="text" name="cuatri" class="form-control" maxlength="20" placeholder="Cuatrimestre" required> 
                            <br><br>
            ...
            <div class="col-lg-9 col-md-12 col-sm-12" style="margin-top: 10px;">
                ...
                <?php 
                    require('../../conexion.php');
                    $querySelect = "SELECT * FROM tbl_cuatrimestre";
                    ...
                    <table class="table table-bordered table-hover table-condensed order-table">
                        ...
                        while ($Fila = mysqli_fetch_array($resbb)) {
                            ?>
                            <tr>
                                <td align="center"> <?php echo $Fila['clv_cuatrimestre'] ?> </td>
                                <td align="center"> <?php echo $Fila['vch_cuatrimestre'] ?> </td>
                                <td align="center"> 
                                    <a href="Update/EditarCuatrimestre.php?id=<?php echo $Fila['clv_cuatrimestre']?>" class="btn btn-small btn-warning">Editar</a>
                                    <a href="Delete/EliminarCuatrimestre.php?id=<?php echo $Fila['clv_cuatrimestre']?>" class="btn btn-small btn-danger">Eliminar</a>
                                </td>
                            </tr>
                        <?php
                        }
