        ...
        <div class="col-lg-3 col-md-12 col-sm-12" style="margin-top: 10px;">
                <div class="card border-primary mb-3" style="max-width: 25rem;">
                    <div class="card-header" align="center">
                        <h4 class="card-title text-dark">Registro de Dispositivos</h4>
                    </div>
                    <div class="card-body">
                        <form action="Insert/RegistrarDispositivos.php" method="post">
                            <input type="text" name="dispositivo" class="form-control" maxlength="50" placeholder="Dispositivos" required> 
                            <br>
                            <input type="text" name="MAC" class="form-control" maxlength="50" placeholder="MAC" required> 
                            <br>
                            Aula
            ...
            <div class="col-lg-9 col-md-12 col-sm-12" style="margin-top: 10px;">
                ...
                <?php 
                    $querySelect = "SELECT * FROM tbl_aulas, tbl_dispositivos 
                                    WHERE tbl_dispositivos.`clv_aula` = tbl_aulas.`clv_aula`";
                    ...
                    <table class="table table-bordered table-hover table-condensed order-table">
                        ...
                        while ($Fila = mysqli_fetch_array($resbb)) {
                            ?>
                            <tr>
                                <td align="center"> <?php echo $Fila['clv_dispositivo'] ?> </td>
                                <td align="center"> <?php echo $Fila['vch_dispositivo'] ?> </td>
                                <td align="center"> <?php echo $Fila['vch_mac_dispositivo'] ?> </td>
                                <td align="center"> <?php echo $Fila['vch_aula'] ?> </td>
                                <td align="center"> 
                                    <a href="Update/EditarDispositivos.php?id=<?php echo $Fila['clv_dispositivo']?>" class="btn btn-small btn-warning">Editar</a>
                                    <a href="Delete/EliminarDispositivos.php?id=<?php echo $Fila['clv_dispositivo']?>" class="btn btn-small btn-danger">Eliminar</a>
                                </td>
                            </tr>
                        <?php
                        }
