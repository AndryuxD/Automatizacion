...
<body>
    ...
    <?php   
        require('../../../conexion.php');
        $id=$_GET['id'];
        $querySelect = "SELECT * FROM tbl_cuatrimestre WHERE clv_cuatrimestre=$id";
        ...
        <br>
            <div class="col-lg-12 col-md-12 col-sm-12" style="margin-top: 10px;" align="center">
                <div class="card border-primary mb-3" style="max-width: 25rem;">
                    <div class="card-header" align="center">
                        <h4 class="card-title text-dark">Editar Cuatrimestre</h4>
                    </div>
                    <div class="card-body">
                        <form action="" method="post">
                            <div align="left">Cuatrimestre</div>
                            <input type="text" name="cuatrimestre" value="<?php echo $row['vch_cuatrimestre'] ?>" class="form-control" maxlength="20" placeholder="Cuatrimestre" required>
            ...
            <?php 
                if ($_POST){
                    ...
                    $strQuerybb="UPDATE tbl_cuatrimestre SET vch_cuatrimestre='$cuatrimestre' WHERE clv_cuatrimestre=$id";
