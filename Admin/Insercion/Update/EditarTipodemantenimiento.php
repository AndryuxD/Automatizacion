        ...
        <br>
            <div class="col-lg-12 col-md-12 col-sm-12" style="margin-top: 10px;" align="center">
                <div class="card border-primary mb-3" style="max-width: 25rem;">
                    <div class="card-header" align="center">
                        <h4 class="card-title text-dark">Editar Tipo de Mantenimiento</h4>
                    </div>
                    <div class="card-body">
                        <form action="" method="post">
                            <div align="left">Tipo</div>
                            <input type="text" name="tipo" value="<?php echo $row['vch_tipo'] ?>" class="form-control" maxlength="50" placeholder="Tipo" required>
                            <br><br>
                            <div class="row">
            ...
            <?php 
                if ($_POST){
                    ...
                    $strQuerybb="UPDATE tbl_tipo_de_mantenimiento SET vch_tipo='$tipo'
                                WHERE clv_tipo_mantenimiento=$id";
